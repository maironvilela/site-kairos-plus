...
export default function PromotionsPage() {
    const [selectedItem, setSelectedItem] = useState<(typeof allPromotions)[0] | null>(null);
            ...
            <div className="flex-grow pt-32 pb-20">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-kairos-wine">Todas as Promoções</h1>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Confira nossa seleção completa de ofertas imperdíveis.
                        </p>
                    </div>
